...
class Dashlet:
    ...
    def __init__(self, driver):
        self.driver = driver
        self.dashlet = '//*[@id="Dashboard0901-SearchTemplate09-box"]'
        self.dashlet_path = self.dashlet + '//form/table/thead/tr/th'
        self.tickets = {}
        self.last_key = 0
    ...
    def get_column_info(self):
        ...
        """
        column_info = []
        columns = self.driver.find_elements_by_xpath(self.dashlet + '//form/table/thead/tr/th')

        for column in columns:
            column_info.append(str(column.text))
            #print(str(column.text))
        return column_info
    ...
    def get_results(self):
        ...
        elements = self.driver.find_elements_by_xpath(self.dashlet + '//form/table/tbody/tr')
        ...
        for element in elements:
            ...
            for column in columns:
                #print('current index: ' + str(current_index) , 'column: ',columns.index(column) , ' column index(column) + 1: ', str(columns.index(column) + 1))

                #print(self.dashlet + '//form/table/tbody/tr[{}]/td[{}]'.format(str(current_index) , str(columns.index(column) + 1)))

                value = element.find_element_by_xpath(self.dashlet + '//form/table/tbody/tr[{}]/td[{}]'.format(str(current_index) , str(columns.index(column) + 1))).text
    ...
    def next_pagination(self, counter):
        ...
        try:
            ...
            print('dì clic')
            time.sleep(5)
            wait.until(EC.visibility_of_element_located((By.XPATH, self.dashlet_path +  '/form/table/tbody')))
